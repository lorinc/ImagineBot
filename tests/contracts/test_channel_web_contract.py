"""Contract tests for the channel_web service API boundary.

Imports directly from src/channel_web/models.py via importlib so that running
...
_path = os.path.join(os.path.dirname(__file__), "../../src/channel_web/models.py")
_spec = importlib.util.spec_from_file_location("channel_web.models", _path)
...
# ---------------------------------------------------------------------------
# POST /chat — request (inbound from browser)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# POST /feedback — request (inbound from browser)
# ---------------------------------------------------------------------------
