#!/usr/bin/env python3
# ARCHIVED — superseded by tools/build_index.py (PageIndex pipeline).
#
# Retained for reference: Firestore config/context_cache schema, Vertex AI
# CachedContent lifecycle, and the service-account IAM bindings are all
# reusable when a vector-based cache layer is added to the knowledge service.
# The Firestore collection/document names and IAM setup in src/knowledge/CLAUDE.md
# remain valid starting points for that future work.
"""
